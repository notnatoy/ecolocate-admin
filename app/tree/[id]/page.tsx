      ...
      <div className="bg-white p-8 rounded-3xl shadow-2xl max-w-md w-full border-t-8 border-[#2E5A38]">
        ...
        <div className="bg-green-50 p-6 rounded-2xl border border-green-100 mb-8">
          ...
          <p className="text-gray-600 text-sm">
            You have discovered a tagged heritage tree!
          </p>
        </div>
        ...
        <div className="space-y-4">
          ...
          {/* DOWNLOAD BUTTON */}
          <a 
            href="https://drive.google.com/uc?export=download&id=1Ttu2rTzrRDHe0fvYVgvzx5fteeIvPaf8" // Ensure you put your .apk file in the 'public' folder!
            target="_blank"
